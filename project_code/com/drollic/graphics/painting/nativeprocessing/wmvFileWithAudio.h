				...
				namespace native					
				{
					...
					{			
						class CwmvFileWithAudio
						{
							...
							HRESULT	(CwmvFileWithAudio::*pAppendFrame[3])(HBITMAP hBitmap);
							...
							HRESULT	(CwmvFileWithAudio::*pAppendFrameBits[3])(int, int, LPVOID,int );
