...
{
	/// <summary>
	/// Summary description for MomentsBasedPainter.
	/// </summary>
	public class MomentsBasedPainter : IPainter
	{
        ...
        {
            return "Moments Based Painter - C#";
        }
