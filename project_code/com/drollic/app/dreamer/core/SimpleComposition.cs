...
{
    public sealed class SimpleComposition : Composition
    {
        ...
        private SimpleComposition(int width, int height)
        ...
        public static Bitmap Test(int width, int height, String searchText, UrlProvider urlProvider)
        {
            ...
            SimpleComposition c = new SimpleComposition(width, height, rand.Next(1, 9), searchText, urlProvider);
            c.Compose();
        ...
        {
            SimpleComposition c = new SimpleComposition(width, height);
        ...
        protected override void CreateSketch()
        {
            ...
            this.sketch = new SimpleSketch(this.compositionWidth, this.compositionHeight, this.subjects);
